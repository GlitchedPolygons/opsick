...
#ifndef OPSICK_GUID_H
#define OPSICK_GUID_H
...
/**
 * @brief Struct containing the output from a call to the {@link #opsick_new_guid()} function. <p>
 * 36 characters (only 32 if you chose to omit the hyphens) + 1 NUL terminator.
 */
typedef struct opsick_guid
{
 ...
 * @return The opsick_guid
 */
opsick_guid opsick_new_guid(bool lowercase, bool hyphens);
