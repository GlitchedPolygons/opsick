...
static const char opsick_sql_get_user[] = "SELECT id, pw, totps, iat_utc, exp_utc, lastmod_utc, public_key_ed25519, encrypted_private_key_ed25519, public_key_curve448, encrypted_private_key_curve448 FROM users WHERE id = ?";
